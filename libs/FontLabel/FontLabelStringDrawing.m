	...
	if (value == nil) {
		...
		if (defaultValues == nil) {
			defaultValues = [[NSDictionary alloc] initWithObjectsAndKeys:
							 ...
							 [NSNumber numberWithInteger:ZUnderlineStyleNone], ZUnderlineStyleAttributeName,
							 nil];
		}
				...
				if (performDraw) {
					switch (alignment) {
						...
						case UITextAlignmentRight:
							...
							break;
                        case NSTextAlignmentNatural:    //RCL 12/11/2012 this is here to suppress a warning
                        case NSTextAlignmentJustified:  //RCL 12/11/2012 this is here to suppress a warning
                            break;
					}
